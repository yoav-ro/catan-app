    ...
    if (number) {
        ...
        return (
            <g>
                ...
                <Junction showModal={showModal} centerX={coordinates.top.x} centerY={coordinates.top.y} />
                <Junction showModal={showModal} centerX={coordinates.topLeft.x} centerY={coordinates.topLeft.y} />
                <Junction showModal={showModal} centerX={coordinates.topRight.x} centerY={coordinates.topRight.y} />
                <Junction showModal={showModal} centerX={coordinates.bottom.x} centerY={coordinates.bottom.y} />
                <Junction showModal={showModal} centerX={coordinates.bottomLeft.x} centerY={coordinates.bottomLeft.y} />
                <Junction showModal={showModal} centerX={coordinates.bottomRight.x} centerY={coordinates.bottomRight.y} />
