...
function Port({ type, x, y, scale: scaleInput }) {
    ...
    return (
        <g onMouseEnter={handleHoverIn} onMouseLeave={handleHoverOut} onClick={handleClick}>
            ...
            L226.496,190.563z"/>
                <path fill="green" d="M110.416,375.186c17.402-12.674,38.307-19.514,60.277-19.514c21.969,0,42.875,6.841,60.277,19.514
            ...
            C95.007,365.49,103.029,369.806,110.416,375.186z"/>
                <path fill="green" d="M456.083,413.984c-11.828-11.828-27.554-18.342-44.281-18.342s-32.453,6.514-44.281,18.342
            ...
            c6.043,0,11.724,2.354,15.997,6.626c7.811,7.81,20.473,7.811,28.284,0C463.894,434.458,463.894,421.794,456.083,413.984z"/>
                {/* <text fill="black" fontSize={20 * unscale} fontWeight="bold">2:1 Wood</text> */}
            </g>
